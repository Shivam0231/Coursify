...
const Purchase = () => {
    ...
    useEffect(()=>{
       ...
       const fetchpurchases=async()=>{
             ...
             try{
                const response = await axios.get(`${backendUrl}/user/purchases`, {
                    headers: {
                        'authorization': `Bearer ${token}`,
                    },
                    withCredentials: true,
                });
                setPurchases(response.data.datas.listcourse);
             }catch(error){
                setErrorMessage( error.response.data.message ||"Failed to fetch purchases");
             }
       };fetchpurchases();
    }, [])
      const toggleSidebar = () => {
